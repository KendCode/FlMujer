        ...
        <form action="{{ route('casos.fichaSeguimientoPsicologico.store', $caso->id) }}" method="POST"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nro_registro" id="nro_registro" class="form-control"
                    style="border-color: #7EC544;" value="{{ old('nro_registro', $caso->nro_registro) }}" readonly>
            </div>

            @php
                // Obtener el último número de sesión y sumar 1 (para mostrar en el formulario)
                $ultimoNumero = \App\Models\FichaSeguimientoPsicologico::where('caso_id', $caso->id)->max('nro_sesion');
            ...
            <div class="mb-3">
                ...
                <input type="number" id="nro_sesion" class="form-control" style="border-color: #7EC544;"
            ...
            <div class="mb-3">
                ...
                <select name="estrategia" id="estrategia" class="form-control" style="border-color: #7EC544;">
                    ...
                    <option value="Individual" {{ old('estrategia') == 'Individual' ? 'selected' : '' }}>Individual</option>
                    <option value="Pareja" {{ old('estrategia') == 'Pareja' ? 'selected' : '' }}>Pareja</option>
                    <option value="Familia" {{ old('estrategia') == 'Familia' ? 'selected' : '' }}>Familia</option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="antecedentes" id="antecedentes" class="form-control" style="border-color: #7EC544;">{{ old('antecedentes') }}</textarea>
            </div>

            <div class="mb-3">
                <label for="conducta_observable" class="form-label" style="color: #037E8C;">Conducta observable</label>
                <textarea name="conducta_observable" id="conducta_observable" class="form-control" style="border-color: #7EC544;">{{ old('conducta_observable') }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="conclusiones_valorativas" id="conclusiones_valorativas" class="form-control"
                    style="border-color: #7EC544;">{{ old('conclusiones_valorativas') }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="estrategias_intervencion" id="estrategias_intervencion" class="form-control"
                    style="border-color: #7EC544;">{{ old('estrategias_intervencion') }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="date" name="fecha_proxima_atencion" id="fecha_proxima_atencion" class="form-control"
                    style="border-color: #7EC544;" value="{{ old('fecha_proxima_atencion') }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nombre_psicologo" id="nombre_psicologo" class="form-control"
                    style="border-color: #7EC544;" value="{{ old('nombre_psicologo') }}">
            </div>
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <button type="submit" class="btn" style="background-color: #13C0E5; color: #fff;">Guardar</button>
            </div>
